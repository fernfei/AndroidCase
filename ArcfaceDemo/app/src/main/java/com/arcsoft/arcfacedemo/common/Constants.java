...
public class Constants {
    ...
    public static final String APP_ID = "HdUdqawB3ztnT8aSqNBUhPKDpY4hxBPeehbezTc9LuRp";
    public static final String SDK_KEY = "8ZGvM9Ed6cN26B8rL19bLUuZqTVQrv3WXUExaxpTPMX4";
